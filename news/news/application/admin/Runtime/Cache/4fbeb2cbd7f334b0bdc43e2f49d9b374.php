...
<html>
  <head>
    ...
    <script type="text/javascript">
      	function delType(articleId,id){
     		 if(confirm("是否删除评论？")){
                 window.location = "__APP__/Reviews/delete/articleId/"+articleId+"/id/"+id;
             }
        }
    </script>
  </head>
...
<script type="text/javascript">
	...
	hello();
      ...
      <div class="rightDiv">
      <br><br><br><br>
        <form name="frm" method="post" action="__APP__/Reviews/delete">
		...
		<?php if(is_array($reviews)): foreach($reviews as $key=>$v): ?><tr  class="modTypeDiv2" style="background-color:#FFFFFF;">
	            <td align="center" width="200"><?php echo ($v["id"]); ?></td>
	            <td align="center" width="200"><?php echo ($v["body"]); ?></td>
	            <td align="center" width="200"><?php echo ($v["userName"]); ?></td>
	            <td align="center" width="200"><?php echo ($v["dateandtime"]); ?></td>
	            <td align="center" width="200">
	             	 <a href="#" onclick="delType(<?php echo ($v["articleId"]); ?>,<?php echo ($v["id"]); ?>)">删除</a>
	            </td>
