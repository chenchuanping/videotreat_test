...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #666666;width:300px;height:216px;">');
...
__ci.document.writeln('select.year {width:100px;}');
__ci.document.writeln('select.month {width:100px;}');
