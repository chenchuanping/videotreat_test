...
class TreatRecordGetAction extends Action
{
    public function index()
    {
        ...
        $userTreatInfo = M("treat_record")
            ->field('treatRecordId,doctor.doctorId,base.userName,doctor.doctorName,userComplaint,userHPC,userPMH,doctorSuggest,treatTime,reportCardRemark,reportCardDescribe,reportCardImage')
