...
return array(
    ...
    /*接口目录*/
    'APP_GROUP_LIST'        => 'Interface',      // 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'
    ...
    /* 数据库设置 */
    'DB_TYPE'               => 'mysql',     // 数据库类型
    'DB_HOST'               => '101.201.104.221', // 服务器地址
  //  'DB_HOST'               => 'localhost', // 服务器地址
    'DB_NAME'               => 'videotreat_test', // 数据库名
//    'DB_NAME'               => 'videotreat', // 数据库名
    'DB_USER'               => 'root',      // 用户名
   'DB_PWD'                => 'adminRoot@123',          // 密码
 //   'DB_PWD'                => '',          // 密码
    'DB_PORT'               => '3306',        // 端口
    'DB_PREFIX'             => '',    // 数据库表前缀
